...
separate (NLColl.Linguistic_Description.Surface)

package body NLColl.Linguistic_Description.Surface.Chars is
begin
    null;

end NLColl.Linguistic_Description.Surface.Chars;
