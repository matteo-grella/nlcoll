...
with NLColl.Transition_Systems.Arc_Spine.State; use NLColl.Transition_Systems.Arc_Spine.State;

package NLColl.Transition_Systems.Arc_Spine.Test is
...
private
    ...
    use NLColl.Transition_Systems.Arc_Spine.State.Actions;
