...
package NLColl.Corpus is

    procedure Empty;
    
    type Corpus_Name_Type is 
      (TRAINSET, 
       DEVSET, 
       TESTSET);
    
    subtype Validation_Corpus_Name_Type is 
      Corpus_Name_Type range DEVSET .. TESTSET;
 
    Corpus_Format_Error : exception;
