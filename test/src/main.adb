...
with NLColl.Corpus.Dictionary_Of_Forms; use NLColl.Corpus.Dictionary_Of_Forms;

procedure Main is

    Forms_Dict : Forms_Dictionary_Type;
    pragma Unreferenced(Forms_Dict);
begin

    Load
      (Forms_Dict           => Forms_Dict,
       Serialized_File_Name => "/home/matteo/Desktop/mg-parsers/model/dictionary",
       Data_Folder_Name     => "/home/matteo/Desktop/mg-parsers/data/it/dictionary/forms");
